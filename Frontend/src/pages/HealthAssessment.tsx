...
const HealthAssessment = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://health-bridge-mtzy.onrender.com/healthcare/form/submit/",
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      const pdf = await axios.get(
        "https://health-bridge-mtzy.onrender.com/healthcare/generate-pdf/",
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
        ...
        {[0, 1, 2, 3, 4].map((step) => (
          <div 
            ...
            className={`h-2 rounded-full transition-all duration-300 ${
              step === currentStep 
                ? "w-8 bg-healthbridge-blue" 
                : step < currentStep 
                  ? "w-4 bg-healthbridge-blue/50" 
                  : "w-4 bg-gray-200"
            }`}
          />
        ))}
  ...
  if (!authChecked) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="animate-pulse text-healthbridge-blue">Verifying your session...</div>
      </div>
    );
  }
  ...
  if (checkingFormStatus) {
    return (
      <div className="flex justify-center items-center min-h-screen">
        <div className="animate-pulse text-healthbridge-blue">Checking your form status...</div>
      </div>
    );
  }
      ...
      <div className="pt-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-3">Health Assessment Form</h1>
            ...
            <CardContent className="p-8">
                ...
                <TabsContent value="review" className="space-y-6">
                  <div className="space-y-6">
                    ...
                    <div className="bg-blue-50 p-4 rounded-lg border border-blue-100 flex items-center gap-3">
                      <Info className="h-5 w-5 text-healthbridge-blue flex-shrink-0" />
                  ...
                  <div className="flex justify-center space-x-4">
                    <Button 
                      ...
                      disabled={isLoading}
                      className="bg-healthbridge-blue hover:bg-healthbridge-blue/90 gap-2"
                    >
              ...
              <div className="mt-12 flex justify-between items-center border-t border-gray-100 pt-6">
                <Button
                  ...
                  className="gap-2 px-6 py-2 min-w-[120px]"
                >
                ...
                <Button
                  ...
                  className="bg-healthbridge-blue hover:bg-healthbridge-blue/90 text-white gap-2 px-6 py-2 min-w-[120px]"
                >
                  Next
